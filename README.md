...
| Before | After |
|--------|-------|
| ![Facebook Before](./images/facebook-before.png) | ![Facebook After](./images/facebook-after.png) |
| *Cluttered with feeds and distractions* | *Clean, messaging-focused interface* |
